...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Dushsmanxroni/Sophia-.git)
     </div>
<br>
<br >
...
```js
SETUP
$ git clone https://github.com/Dushsmanxroni/Sophia
$ cd sophia
$ chmod +x *
$ npm i
$ node qr.js
